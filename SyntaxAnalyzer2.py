    ...
    def __init__(self,t_lexemes,t_idns,t_constants):
        ...
        self.transition_table={
            ...
            3: (
                ...
                {'label': 13, "state": 4, "nezr": self.ERROR,'error_msg':"Немає відкриваючої фігурної дужки"}
            ),
            ...
            10: (
                ...
                {'label': 30, "stack": 12, "state": 10, "nezr": self.ERROR,'error_msg':"Відсутній ідентифікатор або кфт"}
            ),
            ...
            20: (
                ...
                {'label': 11, "state": 43, "nezr": self.ERROR,'error_msg':"Невірний оператор"},
            ),
            ...
            25: (
                ...
                {'label': 17, "stack": 26, "state": 10, "nezr": self.ERROR,'error_msg':"Відсутнє присвоєння або оператор :"},
            ),
        ...
        for transition in transitions:
            ...
            if transition.get("nezr") != None:
                if transition['nezr'] == self.EXIT:
                    ...
                    raise SyntaxException(transition['error_msg'], self.line()-1)
